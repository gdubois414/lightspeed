    ...
    _c("table", [
      ...
      _c(
        ...
        _vm._l(_vm.users, function(user) {
          return _c("tr", [
            _c("td", [_vm._v(_vm._s(_vm._f("capitalize")(user.name)))]),
            _vm._v(" "),
            _c(
              "td",
              _vm._l(user.projects, function(project, index) {
                return _c("span", [
                  _c(
                    "button",
                    {
...
var render = function() {
  ...
  return _c("div", [
    _c("header", { staticClass: "page-header" }, [
      _c("h1", [
        _vm._v(_vm._s(_vm._f("capitalize")(_vm.user.name)) + "'s Project List")
      ])
    ]),
    _vm._v(" "),
    _c("table", [
...
var app = new Vue({
  el: '#app',
  components: {
    AppComponent: _components_AppComponent_vue__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  render: function render(h) {
    return h(_components_AppComponent_vue__WEBPACK_IMPORTED_MODULE_0__["default"]);
  }
});
...
__webpack_require__(/*! /Users/gdubois/Desktop/LightSpeed/project/lightspeed/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/gdubois/Desktop/LightSpeed/project/lightspeed/resources/sass/app.scss */"./resources/sass/app.scss");
